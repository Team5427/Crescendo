...
public class DrivetrainConstants {
    ...
    public static final double MAX_PHYSICAL_SPEED_M_S = (5676 * (14.0 / 50.0) * (28.0 / 16.0) * (15.0 / 45.0)
    ...
    // feedbackConfigs.SensorToMechanismRatio = (14.0 / 50.0) * (28.0 / 16.0) *
    // (15.0 / 45.0) * WHEEL_DIAMETER_METERS * Math.PI;
