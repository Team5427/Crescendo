...
public class ShooterConstants {
    ...
    public static final Rotation2d SHOOTER_PIVOT_ACTIVE = Rotation2d.fromDegrees(-24.0);
    ...
    public static void targetMap() {
        ...
        SHOOTER_PIVOT_TARGET_MAP.put(
            1.5, //DISTANCE METERS
            new ShootingConfiguration(
                Rotation2d.fromDegrees(-20.2), //SHOOTER ROTATION 
                5300, //LEFT RPM
                5300 //RIGHT RPM
            )
        );
        ...
        SHOOTER_PIVOT_TARGET_MAP.put(
            2.1, //DISTANCE METERS
            new ShootingConfiguration(
                Rotation2d.fromDegrees(-26.2), //SHOOTER ROTATION 
                5300, //LEFT RPM
                5300 //RIGHT RPM
            )
        );
        ...
        SHOOTER_PIVOT_TARGET_MAP.put(
            ...
            new ShootingConfiguration(
                Rotation2d.fromDegrees(-32.6), //SHOOTER ROTATION 
                5300, //LEFT RPM
                5300 //RIGHT RPM
            )
        );
        ...
        SHOOTER_PIVOT_TARGET_MAP.put(
            ...
            new ShootingConfiguration(
                Rotation2d.fromDegrees(-39.5), //SHOOTER ROTATION 
                5300, //LEFT RPM
                5300 //RIGHT RPM
            )
        );
        ...
        SHOOTER_PIVOT_TARGET_MAP.put(
            ...
            new ShootingConfiguration(
                Rotation2d.fromDegrees(-41.2), //SHOOTER ROTATION 
                5300, //LEFT RPM
                5300 //RIGHT RPM
            )
        );
        ...
        SHOOTER_PIVOT_TARGET_MAP.put(
            ...
            new ShootingConfiguration(
                Rotation2d.fromDegrees(-43.2), //SHOOTER ROTATION 
                5100, //LEFT RPM
                5300 //RIGHT RPM
            )
        );
        ...
        SHOOTER_PIVOT_TARGET_MAP.put(
            5.0, //DISTANCE METERS
            new ShootingConfiguration(
                Rotation2d.fromDegrees(-44.5), //SHOOTER ROTATION 
                5100, //LEFT RPM
                5300 //RIGHT RPM
            )
        );
        ...
        SHOOTER_PIVOT_TARGET_MAP.put(
            5.5, //DISTANCE METERS
            new ShootingConfiguration(
                Rotation2d.fromDegrees(-45.5), //SHOOTER ROTATION 
                5100, //LEFT RPM
                5300 //RIGHT RPM
            )
        );
